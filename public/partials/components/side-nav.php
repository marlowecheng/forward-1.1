<aside class="side-nav">
    ...
    <div class="nav-links">
        <ul>
            ...
            <li><img class="nav-icon" src="<?php echo get_public_url('images/Icons/users.svg'); ?>" alt=""><a href="#" title="View Your Communities">My Community</a></li>
            <li><img class="nav-icon" src="<?php echo get_public_url('images/Icons/more-horizontal.svg'); ?>" alt=""><a href="#" title="More options">More</a></li>
        </ul>
    </div>
</aside>